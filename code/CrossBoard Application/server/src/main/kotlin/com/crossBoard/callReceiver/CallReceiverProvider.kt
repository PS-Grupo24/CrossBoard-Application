...
object CallReceiverProvider {
     ...
     *
     * Each receiver in this list is responsible for handling the deserialization of a [MoveInput]
    ...
    fun get(matchType: MatchType) : CallReceiver<*> {
        return (callReceiversMap[matchType]
            ?: throw IllegalArgumentException("No UIModule found for MatchType: $matchType")) as CallReceiver<MoveInput>
    }
}