 ...
 *
 * This class handles the deserialization of [TicTacToeMoveInput] from a Ktor [RoutingCall].
 ...
 */
class TicReceiver : CallReceiver<TicTacToeMoveInput> {
    override val matchType = MatchType.TicTacToe
    override suspend fun callReceive(call: RoutingCall): TicTacToeMoveInput {
        return call.receive<TicTacToeMoveInput>()
    }
}