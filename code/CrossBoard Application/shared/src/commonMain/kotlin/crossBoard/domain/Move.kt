...
import crossBoard.httpModel.MoveOutput
import crossBoard.httpModel.TicTacToeMoveOutput
...
fun MoveOutput.toMove(): Move {
    return when (this) {
        is TicTacToeMoveOutput -> TicTacToeMove(player.toPlayer(), square.toSquare(crossBoard.domain.TicTacToeBoard.BOARD_DIM))
    }
}