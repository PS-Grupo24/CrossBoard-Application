...
import crossBoard.httpModel.TicTacToeMoveInput
import crossBoard.httpModel.toMultiplayerMatch
...
class TicTacToeViewModel(
    ...
    fun findMatch(userToken: String){
        val currentState = _matchState.value
    ...
    fun forfeit(userId: Int, userToken: String){
        val currentState = _matchState.value
        val match = currentState.currentMatch ?: return
    ...
    fun getPlayersUsernames(player1Id:Int?, player2Id: Int?){
